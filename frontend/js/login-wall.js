  ...
  function modalHtml(mode) {
    if (mode === 'free') {
      return ''
        ...
        + '<p class="lw-sub">You have a free account - take the next step and enrol in one of Dr. Jaspal Singh’s offline programs in Jaipur.</p>'
        ...
        +   '<div class="lw-benefit"><i class="fas fa-medal"></i> Mentored by an AIR-04 GATE topper</div>'
        + '</div>'
